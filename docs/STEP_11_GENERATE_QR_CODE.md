...
- `uri` - изображение QR-кода для отображения в браузере;
- `raw` - изображение QR-кода в исходном формате.

### Реализация

Пример реализации [Mitwork\Kalkan\Http\Actions\GenerateQrCode.php](../src/Http/Actions/GenerateQrCode.php)
...
// ...
'actions' => [
    'generate-qr-code' => 'custom-generate-qr-code',
]
// ..
```
